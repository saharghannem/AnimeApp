 ...
 */
final class Version20250415011143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX team_id ON discussion
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX user_id ON discussion
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE discussion CHANGE id id INT NOT NULL, CHANGE message message LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX assigned_team_id ON incident
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX reported_by ON incident
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE incident DROP assigned_team_id, DROP plan_id, DROP reported_by, CHANGE id id INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE status status VARCHAR(50) NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE resources resources LONGTEXT NOT NULL, CHANGE required_vehicles required_vehicles LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE delay delay INT NOT NULL, CHANGE incident_date incident_date DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE discussion CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE message message TEXT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX team_id ON discussion (team_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX user_id ON discussion (user_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE incident ADD assigned_team_id INT DEFAULT NULL, ADD plan_id INT DEFAULT NULL, ADD reported_by INT DEFAULT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE status status VARCHAR(50) DEFAULT 'Nouveau' NOT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE resources resources TEXT DEFAULT NULL, CHANGE required_vehicles required_vehicles TEXT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE delay delay INT DEFAULT NULL, CHANGE incident_date incident_date DATETIME DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX assigned_team_id ON incident (assigned_team_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX reported_by ON incident (reported_by)
        SQL);
        $this->addSql(<<<'SQL'
